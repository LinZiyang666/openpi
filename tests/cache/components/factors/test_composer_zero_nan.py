"""Unit tests for WeightedSumZeroNanComposer (Phase 3 sweep composer).

Plan §2 / §5.5: equal-weight sum where NaN keys contribute 0 (still
counted in denominator). Two-tier inclusive cascade. No all-NaN warm
fallback path. Distinct from WeightedSumComposer (NaN-skip denominator)
and WeightedSumWithWarmFallbackComposer (all-NaN warm fallback).
