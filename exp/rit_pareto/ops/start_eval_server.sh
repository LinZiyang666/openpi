...
rm -f /tmp/srv0.log
tmux new -s srv0 -d 'cd /data/openpi_dispatch && export HOME=/home/weiland && export PYTHONPATH=/data/openpi_dispatch/src:/data/openpi_dispatch && export OPENPI_SERVER_GPU_MEMORY_LOCK=0 && /home/weiland/projects/openpi/.venv/bin/python scripts/serve_policy.py --replicas 4 --replica-spawn-batch 2 --port 23150 policy:checkpoint --policy.config pi05_libero --policy.dir /home/weiland/.cache/openpi/openpi-assets/checkpoints/pi05_libero_pytorch 2>&1 | tee /tmp/srv0.log'
echo "srv0 launched"
