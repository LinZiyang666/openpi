...
| midfinal_t0.5 - warm_t0.5 | 50 | +0.04 | [-0.06, +0.16] | 5 / 3 |
| midfinal_t0.5 - warmreset_t0.5 | 50 | -0.02 | [-0.12, +0.08] | 3 / 4 |
| midfinal_t0.5 - resetfinal_t0.5 | 50 | +0.00 | [-0.12, +0.12] | 4 / 4 |
...
| plain_k2 | 2 | 0.660 |
| warm_t0.5 | 2 | 0.560 |
| warmreset_t0.5 | 2 | 0.650 |
| warmshoot_t0.5 | 0 | – |
| resetfinal_t0.5 | 2 | 0.620 |
| midfinal_t0.5 | 2 | 0.680 |

| macro paired difference | tasks | Δ | 95% CI |
|---|---|---|---|
| warmreset_t0.5 - plain_k2 | 2 | -0.010 | [-0.100, +0.080] |
| warmreset_t0.5 - warm_t0.5 | 2 | +0.090 | [-0.020, +0.200] |
| warmreset_t0.5 - resetfinal_t0.5 | 2 | +0.030 | [-0.070, +0.130] |
| warmreset_t0.5 - full | 2 | +0.150 | [+0.050, +0.250] |
| resetfinal_t0.5 - plain_k2 | 2 | -0.040 | [-0.130, +0.050] |
| resetfinal_t0.5 - warm_t0.5 | 2 | +0.060 | [-0.040, +0.160] |
| resetfinal_t0.5 - warmreset_t0.5 | 2 | -0.030 | [-0.130, +0.070] |
| resetfinal_t0.5 - full | 2 | +0.120 | [+0.020, +0.210] |
| midfinal_t0.5 - plain_k2 | 2 | +0.020 | [-0.080, +0.120] |
| midfinal_t0.5 - warm_t0.5 | 2 | +0.120 | [+0.010, +0.230] |
| midfinal_t0.5 - warmreset_t0.5 | 2 | +0.030 | [-0.070, +0.130] |
| midfinal_t0.5 - resetfinal_t0.5 | 2 | +0.060 | [-0.050, +0.170] |
| midfinal_t0.5 - full | 2 | +0.180 | [+0.070, +0.290] |
| warm_t0.5 - plain_k2 | 2 | -0.100 | [-0.200, +0.000] |
| warm_t0.5 - warmreset_t0.5 | 2 | -0.090 | [-0.200, +0.020] |
| warm_t0.5 - resetfinal_t0.5 | 2 | -0.060 | [-0.160, +0.040] |
| warm_t0.5 - full | 2 | +0.060 | [-0.040, +0.160] |
