...
def _write_report_en(
    ...
    lines: list[str] = [
        ...
        "",
        "```bash",
        "uv run python -m exp.trajectory_deviation.analyze_step2_deviate_scores \\",
        ...
        "",
        "```bash",
        "uv run python -m exp.trajectory_deviation.plot_deviate_score_distribution \\",
        f"    --score-dir {score_dir}",
        "```",
        "",
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--gt-dir",
        default="data/deviation_experiment/gt",
