...
| [paper_workbench.md](paper_workbench.md) | Paper idea development: elevator pitch, motivation, story arc, method sketch, experiment plan, positioning, open questions |
